...
class UseCaseController extends Controller
{
    ...
    public function storeAppointment(Request $request)
    {
        ...
        // Generate appointment ID (UUID v4)
        $appointmentId = (string) \Ramsey\Uuid\Uuid::uuid4();
        ...
        $appointmentDoc = [
            ...
            // embed service_method and repair_services details if you want, otherwise just IDs
        ];

        $this->mongo->appointments->insertOne($appointmentDoc);

        // Insert the repair services linked to this appointment
    ...
    public function listAppointments()
    {
        ...
        // Aggregation to get appointments with method_name and concatenated service names
        $pipeline = [
            [
            ...
            [
                '$group' => [
                    ...
                    'method_name' => ['$first' => ['$arrayElemAt' => ['$method_info.method_name', 0]]],
